//! Hot-reload watcher for `agents-js/*.js`.
//!
//! Same shape as `cafe-agent-runtime/src/watcher.rs`: yields paths of changed
//! `.js` files; the supervisor decides (via `allows_reload`) whether to apply.
